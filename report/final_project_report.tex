...
\newcommand{\githuburl}{\textcolor{red}{TODO: GitHub URL}}
\newcommand{\livedemo}{\textcolor{red}{TODO: Vercel URL}; local fallback runs at \url{http://127.0.0.1:8787/}}
...
\begin{enumerate}
  ...
  \item delivery through a live Vercel dashboard, local fallback dashboard, CLI output, and CSV evidence exports.
\end{enumerate}
...
\end{verbatim}
Then open \url{http://127.0.0.1:8787/}.
